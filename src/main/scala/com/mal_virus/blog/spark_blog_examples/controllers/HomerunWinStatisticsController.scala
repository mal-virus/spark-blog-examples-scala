...
object HomerunWinStatisticsController extends Baseball {
	def main(args: Array[String]) {
	  ...
	  // raw lines of our source file stored in a Resillient Distributed Dataset
	...
	def calculateByTeam(v1:  (String, (Iterable[Array[String]], Iterable[Array[String]]))) = {
		   ...
		   * allGames is a Tuple3 of (our team score, opposition team score, our team's homeruns)
		   */
		  var allGames =
		  ...
		  /**
		   * First, check to see if our team one
